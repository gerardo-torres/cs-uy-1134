...
def sum_lnk_lst(lnk_lst):
    ...
    return sum_lnk_lst_helper(lnk_lst, lnk_lst.first_node())

def sum_lnk_lst_helper(lnk_lst, first_node):
    if first_node.next.data == None:
        return first_node.data
    call = sum_lnk_lst_helper(lnk_lst, first_node.next)
    return first_node.data + call
