...
def check_if_palindrome(lnk_lst, left, right):
    if (left is right) or (left.prev == right):
        print('last')
        return True
    else:
        print('else')
        if left.data == right.data:
            return check_if_palindrome(lnk_lst, left.next, right.prev)
        else:
            return False
...
def main():
    ...
    lnk_lst.add_last('h')
    lnk_lst.add_last('a')
    print(check_if_palindrome(lnk_lst, lnk_lst.first_node(), lnk_lst.last_node()))
